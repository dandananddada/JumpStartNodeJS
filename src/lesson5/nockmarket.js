...
stocks.forEach(function(stock){
 ...
 function submitRandomOrder(index){
 	...
 	if (ord.type==exch.BUY)		allData[index] = exch.buy(ord.price, ord.volume, exchangeData);
 	else						allData[index] = exch.sell(ord.price, ord.volume, exchangeData);
